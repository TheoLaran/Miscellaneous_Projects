...
contract CardBizz is ERC1155, Ownable, ERC1155Supply {
  ...
  function getPlayerName(address addr) public view returns (string memory) {
    require(isPlayer(addr), "Player doesn't exist!");
    return getPlayer(addr).playerName;
  }
